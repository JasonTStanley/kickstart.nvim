...
# Include paths
# ------------------------------------------------------------
# Automatically collect all cpp files from src/ Add your include directory
# (`include/`)
...
# target_link_libraries(${PROJECT_EXEC} PRIVATE Eigen3::Eigen
# ${OpenCV_LIBRARIES})
#
...
#
# add_subdirectory(external/mylib) target_link_libraries(${PROJECT_EXEC} PRIVATE
# mylib)
#
...
#
# option(USE_FAST_MATH "Enable fast math" OFF) if(USE_FAST_MATH)
# target_compile_definitions(${PROJECT_EXEC} PRIVATE ENABLE_FAST_MATH) endif()
#

# ------------------------------------------------------------
# Additional compile flags (optional)
# ------------------------------------------------------------
target_compile_options(${PROJECT_EXEC} PRIVATE -Wall -Wextra -Wpedantic)
